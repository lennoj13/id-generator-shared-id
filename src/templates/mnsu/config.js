 ...
 * Purple & Gold academic aesthetic
 */
const mnsuConfig = {
  id: 'mnsu',
  ...
  majors: {
    swe: {
      ...
      courses: [
        { code: 'CIS 455-01', crn: '004892', title: 'Software Quality Assurance & Security Auditing', cr: '4.0', times: 'Tue 18:00-20:00 / Wed 18:00-21:00', loc: 'Online Zoom Live', room: 'Wissink Hall Sync', inst: 'Dr. M. Lindholm', type: 'Online Sync', desc: 'Comprehensive study of software testing methodologies, automated test suites, OWASP security principles, auditing metrics, and verification.' },
        { code: 'IT 440-01', crn: '004895', title: 'IT Project Management & Agile Systems', cr: '4.0', times: 'Tue 20:00-22:00 / Thu 18:00-21:00', loc: 'Online Zoom Live', room: 'Trafton Science CSET', inst: 'Dr. S. K. Johnson', type: 'Online Sync', desc: 'Agile methodologies, sprint planning, project governance, risk mitigation, and team leadership in technical projects.' },
        ...
        { code: 'CIS 485-01', crn: '004918', title: 'Senior Software Architecture & Web Cloud', cr: '4.0', times: 'Thu 21:00-23:00 / Fri 21:00-23:00', loc: 'Online Zoom Live', room: 'Wissink Cloud Lab', inst: 'Dr. D. F. Keefe', type: 'Online Sync', desc: 'Distributed systems, REST/GraphQL cloud services, CI/CD pipeline automation, Docker containerization, and capstone engineering.' }
      ]
    },
    cs: {
    ...
    nurs: {
      ...
      courses: [
        ...
        { code: 'NURS 386-01', crn: '005128', title: 'Health Assessment & Clinical Skills', cr: '4.0', times: 'Tue 08:00-12:00 (Lab)', loc: 'Wissink Hall Sim Lab', room: 'WH 101 Sim', inst: 'Dr. K. Miller', type: 'In-Person', desc: 'Systematic physical assessment techniques, patient interviewing, health history, and core bedside clinical interventions.' },
    ...
    av: {
      ...
      courses: [
        ...
        { code: 'AVIA 151-01', crn: '006105', title: 'Primary Flight Lab - Mankato Airport (MKT)', cr: '2.0', times: 'Scheduled Flight Blocks', loc: 'Mankato Regional Airport', room: 'MKT Hangar 3', inst: 'MNSU Flight Instructors', type: 'In-Person', desc: 'Dual flight instruction in Piper Archer aircraft, stalls, cross-country navigation, and FAA private pilot checkride.' },
        ...
        { code: 'MATH 112-01', crn: '001210', title: 'College Algebra & Trigonometry', cr: '4.0', times: 'Mon/Tue/Wed/Thu 14:00-14:50', loc: 'Armstrong Hall 101', room: 'AH 101', inst: 'Prof. S. Davis', type: 'In-Person', desc: 'Functions, vectors, trigonometric identities, and algebraic problem-solving for aviation applications.' }
      ]
    },
    acct: {
      name: 'B.S. Accounting',
